...
static iomux_v3_cfg_t const usdhc1_pads[] = {
	...
	MX6_PAD_ENET_TXD1__GPIO1_IO29  | MUX_PAD_CTRL(NO_PAD_CTRL), /* CD */
	MX6_PAD_ENET_RXD1__GPIO1_IO26  | MUX_PAD_CTRL(NO_PAD_CTRL), /* sd1 PWR EN */
};

static iomux_v3_cfg_t const usdhc3_pads[] = {  /* magik-2 emmc */
	...
	MX6_PAD_SD3_RST__SD3_RESET |  MUX_PAD_CTRL(USDHC_PAD_CTRL), /* sd3 reset */
};
...
static iomux_v3_cfg_t const usdhc4_pads[] = {
	...
	MX6_PAD_NANDF_ALE__SD4_RESET | MUX_PAD_CTRL(USDHC_PAD_CTRL), /* sd4 RST */
};
...
#define USDHC1_CD_GPIO	IMX_GPIO_NR(1, 29)
...
static iomux_v3_cfg_t const usb_otg_pads[] = {
	MX6_PAD_GPIO2__GPIO1_IO2 | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_GPIO1__USB_OTG_ID | MUX_PAD_CTRL(OTG_ID_PAD_CTRL),
};
*/
...
int power_init_board(void)
{
	...
	if (is_mx6dqp()) {
		...
		/* extra setting for magik2 som for USB host to enable */
